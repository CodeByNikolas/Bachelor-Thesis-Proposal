...
Second, since many students work on identical starter projects, each internal language server independently computes and stores nearly identical data structures, such as Abstract Syntax Trees (ASTs) and symbol indexes, leading to considerable data redundancy across the cluster @barros:2022:EditingSupportSoftware.
